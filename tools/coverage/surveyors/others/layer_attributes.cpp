...
Value observeLayerAttributes(const SurveyContext& ctx)
{
    ...
    for (const auto& layer : sourceInstances<Target>(ctx)) {
        result.push_back(observe(*layer, ctx, field("cmper", [](const Target& value) { return value.getCmper(); }),
            field("rest_offset", &Target::restOffset), field("freez_ties_to_stems", &Target::freezTiesToStems),
            field("only_if_other_layers_have_notes", &Target::onlyIfOtherLayersHaveNotes), field("use_rest_offset", &Target::useRestOffset),
            field("freeze_stems_up", &Target::freezeStemsUp), field("freeze_layer", &Target::freezeLayer), field("playback", &Target::playback),
            field("affect_spacing", &Target::affectSpacing), field("ignore_hidden_notes_only", &Target::ignoreHiddenNotesOnly),
            field("ignore_hidden_layers", &Target::ignoreHiddenLayers), field("hide_layer", &Target::hideLayer),
            ...
            field("origin_onlyIfOtherLayersHaveNotes", layerAttributeOrigin("onlyIfOtherLayersHaveNotes")),
            field("origin_useRestOffset", layerAttributeOrigin("useRestOffset")),
            field("origin_freezeStemsUp", layerAttributeOrigin("freezeStemsUp")), field("origin_freezeLayer", layerAttributeOrigin("freezeLayer")),
            field("origin_playback", layerAttributeOrigin("playback")), field("origin_affectSpacing", layerAttributeOrigin("affectSpacing")),
            field("origin_ignoreHiddenNotesOnly", layerAttributeOrigin("ignoreHiddenNotesOnly")),
