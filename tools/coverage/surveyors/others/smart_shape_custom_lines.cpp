...
Value observeSmartShapeCustomLines(const SurveyContext& ctx)
{
    ...
    for (const auto& line :
        ...
        result.emplace_back(observe(*line, ctx,
            ...
            field("left_cont_x", &CustomLine::leftContX), field("left_cont_y", &CustomLine::leftContY),
            field("right_end_x", &CustomLine::rightEndX), field("right_end_y", &CustomLine::rightEndY),
            field("center_full_x", &CustomLine::centerFullX), field("center_full_y", &CustomLine::centerFullY),
            field("center_abbr_x", &CustomLine::centerAbbrX), field("center_abbr_y", &CustomLine::centerAbbrY),
            field("line_start_x", &CustomLine::lineStartX), field("line_start_y", &CustomLine::lineStartY),
