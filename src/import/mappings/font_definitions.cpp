...
const MappingTable& fontDefinitionsTable()
{
    static const MappingTable table{
        "others.fontName",
        EpochMask::CodaBanner | EpochMask::FixedRow,
        versions::from(headerFirstVersion, headerFirstMinor),
        TargetKind::OthersFromRecords,
        nullptr,
        "FN",
        &createOthersTarget<Target>,
        fontFields,
        std::size(fontFields)};
    return table;
}
...
const MappingTable& earlyFontDefinitionsTable()
{
    static const MappingTable table{
        "others.fontName",
        EpochMask::CodaBanner | EpochMask::FixedRow,
        versions::upTo(headerFirstVersion, headerFirstMinor - 1),
        TargetKind::OthersFromRecords,
        nullptr,
        "FN",
        &createOthersTarget<Target>,
        earlyFontFields,
        std::size(earlyFontFields)};
    return table;
}
