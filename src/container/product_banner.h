...
struct ProductBanner
{
    ...
    /// Believed: `1.0+` is the only version used here, but the platform is stated separately
    /// from the version on purpose. Matching the whole string would reject a Windows document
