...
[font_definitions.md](../format/others/font_definitions.md#unresolvable-comparators-and-the-missing-font-n-placeholder).
...
[LEGACY_OPTION_MAPPINGS.md](../reference/LEGACY_OPTION_MAPPINGS.md#corpus-verification-of-promoted-mappings).
...
[clef_options.md](../format/options/clef_options.md#clef-definitions).
...
- **One Finale 97 file** overran the customary `0x200` body boundary with long
  ...
  [header.md](../format/container/header.md#banner-era-files); the controlled pair under
...
signature. See
[zlib_blocks.md](../format/container/zlib_blocks.md#which-blocks-are-compressed). The container now
...
baseline (see [P0.3](#p03-platform-matched-baseline-selection)).
...
The reasoning in [P0.2](#p02-remaining-seeded-option-font-ids-are-not-reconciled)
...
[VERSION_MATRIX.md](../reference/VERSION_MATRIX.md#decoded-version-packing). The consequences for
gating:
...
[graphic_assignments.md](../format/others/graphic_assignments.md#embedded-graphics).
...
- **77 `staffNames`.** The Coda-banner era stores one `Name` preference where
  ...
  [`format/options/font_options.md`](../format/options/font_options.md#the-single-name-preference-reaches-all-four-modern-name-types),
