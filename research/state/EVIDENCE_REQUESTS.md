...
them. Findings are in [byte_order.md](../format/container/byte_order.md#determining-byte-order) and the reader work
...
table is in [`format/options/font_options.md`](../format/options/font_options.md) and their provenance and hashes are in `tests/evidence/F100/provenance.txt`. Features
...
[LEGACY_OPTION_MAPPINGS.md](../reference/LEGACY_OPTION_MAPPINGS.md#fontoptions-sequence-verification-strategy).
...
[clef_options.md](../format/options/clef_options.md#clef-definitions): the 2001-and-later unit is Efix in a signed
...
types (see [`format/options/font_options.md`](../format/options/font_options.md#the-single-name-preference-reaches-all-four-modern-name-types)). The
...
Full results are in [text_options.md](../format/options/text_options.md#text-options).
...
[text_pool.md](../format/texts/text_pool.md#enigma-commands-in-the-compressed-epochs).
