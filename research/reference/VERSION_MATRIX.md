...
| Finale 2001 | 24 | 967 | 4 | DCL-compressed legacy | typed/length/CRC blocks in both byte orders; 3/4 corpus files framed, all 9 members DCL/CRC-valid | yes | controlled Windows fixtures confirm little-endian DCL and fixed rows at the major codec boundary |
...
version could: see [`format/options/font_options.md`](../format/options/font_options.md#the-1328-boundary-is-finale-2012-not-finale-2003).
