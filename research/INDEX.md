...
| others | [`format/others/`](format/others/) | `font_definitions`, `shape_definitions`, `fret_records`, `graphic_assignments`, `smart_shape_custom_lines`, `text_blocks`, `layer_attributes`, `part_definitions` |
