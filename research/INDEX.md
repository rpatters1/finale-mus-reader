...
| others | [`format/others/`](format/others/) | `chord_suffix_elements`, `chord_suffix_playback`, `font_definitions`, `shape_definitions`, `fret_records`, `graphic_assignments`, `smart_shape_custom_lines`, `staff_list`, `text_blocks`, `layer_attributes`, `part_definitions`, `part_globals` |
